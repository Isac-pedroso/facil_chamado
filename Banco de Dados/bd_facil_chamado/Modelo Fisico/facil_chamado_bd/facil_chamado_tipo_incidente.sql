...
INSERT INTO `tipo_incidente` VALUES (1,'Chamado técnico'),(2,'Chamado usuário'),(3,'Manutenção preventiva'),(4,'Manutenção corretiva'),(5,'Em atendimento'),(6,'Em analise'),(7,'Aguardando');
