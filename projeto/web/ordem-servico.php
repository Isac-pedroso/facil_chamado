...
<head>
    ...
    <link href="../css/ordem-servico.css" rel="stylesheet">
                ...
                <div class="cabecalho-os">
                    ...
                    <div class="cabecalho-os-meio">
                        ...
                        <div class="status-os">
                            ...
                            <select class="form-select" id="stt_os">
                        ...
                        <div class="contatos">
                            ...
                            <div class="todos-contatos">
                                <div class="contatos-da-os">
                                    <p class="pContatos">Contados Ordem de Serviço:</p>
                                </div>
                                <div class="contatos-novos">
                                    <p class="pContatos">Contados novos:</p>
                                    <div class="conteudo-contatos-novos"></div>
                                </div>
                            </div>
                        </div>
                        <div class="anexos">
                            ...
                            <div class="todos-anexos">
                                <div class="anexos-da-os">
                                    <p class="pContatos">Anexos Ordem de Serviço:</p>
                                </div>
                                <div class="anexos-novos">
                                    <p class="pContatos">Anexos novos:</p>
                                </div>
                            </div>
                        </div>
